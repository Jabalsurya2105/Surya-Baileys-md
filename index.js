 ...
 * Recode By Surya
 * Contact Me on wa.me/62895415497664
*/
...
browser: ['Surya Multi Device','Safari','1.0.0'],
auth: state
})
...
m = smsg(hisoka, mek)
require("./surya")(hisoka, m, chatUpdate)
} catch (err) {
console.log(err)
}
})
...
console.log(color(`[•]`, 'aqua'), color('Nama        : Suryaㄙ×፝֟͜×︎', 'white'))
console.log(color(`[•]`, 'aqua'), color('Bot Version  : 2.1.1', 'white'))
console.log(color(`[•]`, 'aqua'), color('Status       : Online!', 'white'))
console.log(color(`[•]`, 'aqua'), color('Owner       : 62895415497664', 'white'))
console.log(color(`< ================================================== >`, 'cyan'))
}
